;; Genearated with: ./generator.py single-source-move-to-locations 3 10 10 1 prob.pddl --random-seed 4754
;; Random seed: 4754
(define (problem recharge-single-source-move-to-locations-9737)
...
(:init
  ...
  (connected location-0032 location-0039)
  ...
  (connected location-0002 location-0038)
  ...
  (connected location-0005 location-0036)
  ...
  (connected location-0035 location-0047)
  ...
  (connected location-0042 location-0046)
  (connected location-0010 location-0041)
...
;; Cost: 13
;; Plan:
;; (recharge robot-02 robot-00 location-0008 battery-0006 battery-0005 battery-0000 battery-0001)
;; (recharge robot-02 robot-00 location-0008 battery-0005 battery-0004 battery-0001 battery-0002)
;; (recharge robot-02 robot-00 location-0008 battery-0004 battery-0003 battery-0002 battery-0003)
;; (recharge robot-02 robot-01 location-0008 battery-0003 battery-0002 battery-0003 battery-0004)
;; (move robot-00 location-0008 location-0033 battery-0003 battery-0002)
;; (move robot-00 location-0033 location-0032 battery-0002 battery-0001)
;; (move robot-00 location-0032 location-0029 battery-0001 battery-0000)
;; (move robot-01 location-0008 location-0009 battery-0004 battery-0003)
;; (move robot-01 location-0009 location-0023 battery-0003 battery-0002)
;; (move robot-01 location-0023 location-0024 battery-0002 battery-0001)
;; (move robot-01 location-0024 location-0013 battery-0001 battery-0000)
;; (move robot-02 location-0008 location-0000 battery-0002 battery-0001)
;; (move robot-02 location-0000 location-0037 battery-0001 battery-0000)
